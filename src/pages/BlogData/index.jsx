...
export default function BlogData() {
  ...
  return (
    <div className="h-full w-full flex flex-col gap-10 pt-[20px] text-[30px]">
      <Navbar />
      <div className="text-center font-semibold text-[30px] md:text-[40px] lg:text-[50px] xl:text-[60px] font-serif px-[25px] lg:px-[50px]">
        {blog.title}
      </div>
      <div className="flex w-full font-semibold text-[20px] lg:text-[25px] xl:text-[30px] font-serif flex-wrap gap-2 px-[25px] lg:px-[50px]">
      ...
      <div className="text-left mx-[20px] md:mx-[7.5%] lg:mx-[20%] font-semibold text-[15px] md:text-[20px] lg:text-[25px] xl:text-[30px] font-serif px-[25px] lg:px-[50px]">
