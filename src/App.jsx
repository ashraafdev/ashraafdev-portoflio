...
function App() {
  ...
  const firebaseConfig = {
    ...
    storageBucket: import.meta.env.VITE_STORAGE_BUCKET ? import.meta.env.VITE_STORAGE_BUCKET : process.env.VITE_STORAGE_BUCKET,
    messagingSenderId: import.meta.env.VITE_MESSAGING_SENDER_ID ? import.meta.env.VITE_MESSAGING_SENDER_ID : process.env.VITE_MESSAGING_SENDER_ID,
    appId: import.meta.env.VITE_APP_ID ? import.meta.env.VITE_APP_ID : process.env.VITE_APP_ID,
  };
